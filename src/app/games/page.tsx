            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        {game.tags.map(tag => (
                                            <span
                                                key={tag}
                                                className="px-2.5 py-1 text-xs font-medium bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-full"
                                            >
                                                {tag}
                                            </span>
                                        ))}
                                    ...
                                    {/* Play Button */}
                                    <div className="flex items-center text-amber-700 dark:text-amber-400 font-semibold group-hover:gap-3 gap-2 transition-all duration-300">
                                        <span>Play Now</span>
                ...
                <div className={`mt-12 max-w-5xl mx-auto transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="glass rounded-2xl p-8 text-center border-2 border-dashed border-gray-300 dark:border-gray-700">
                        ...
                        <h3 className="text-xl font-bold text-gray-500 dark:text-gray-400 mb-2">More Games Coming Soon</h3>
                        <p className="text-gray-400 dark:text-gray-500">Stay tuned for more browser-based mini games!</p>
                    </div>
                </div>
            </div>
        </div>
