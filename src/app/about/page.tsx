        ...
        <div className="min-h-screen pt-24 pb-16">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="w-24 h-1 bg-gradient-to-r from-amber-700 to-stone-600 mx-auto rounded-full"></div>
                </div>
                ...
                <div className={`transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="space-y-8 relative before:absolute before:inset-0 before:ml-5 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-amber-700 before:to-stone-600 md:before:ml-0 md:before:left-1/2">
                        ...
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                            ...
                            <div className="w-[calc(50%-40px)] glass p-6 rounded-xl shadow-xl md:w-5/12">
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-1">AI Engineer</h3>
                                <p className="text-amber-800 dark:text-amber-300 font-semibold mb-2">Peterson Partners | May 2026 – Present</p>
                                <p className="text-gray-700 dark:text-gray-300">Engineering RAG ingestion pipelines and AI workflows for automated investor reporting at a private equity firm.</p>
                            </div>
                        </div>

                        {/* Experience Item 1 - BYU Office of IT */}
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-amber-700 shadow-lg md:order-1 md:mx-auto z-10">
                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="w-[calc(50%-40px)] glass p-6 rounded-xl shadow-xl md:w-5/12">
                                ...
                                <p className="text-amber-700 dark:text-amber-400 font-semibold mb-2">BYU Office of IT | Jan 2024 - Apr 2026</p>
                        ...
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-stone-600 shadow-lg md:order-1 md:mx-auto z-10">
                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="w-[calc(50%-40px)] glass p-6 rounded-xl shadow-xl md:w-5/12">
                                ...
                                <p className="text-stone-600 dark:text-stone-400 font-semibold mb-2">Connor Group | Jun 2025 - Aug 2025</p>
                        ...
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-amber-600 shadow-lg md:order-1 md:mx-auto z-10">
                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="w-[calc(50%-40px)] glass p-6 rounded-xl shadow-xl md:w-5/12">
                                ...
                                <p className="text-amber-600 dark:text-amber-400 font-semibold mb-2">BK Underwood Marketing LLC | Jan 2024 - Present</p>
                        ...
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                            <div className="flex items-center justify-center w-10 h-10 rounded-full bg-stone-500 shadow-lg md:order-1 md:mx-auto z-10">
                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                                    <path fillRule="evenodd" d="M6 2a1 1 0 00-1 1v1H4a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1V3a1 1 0 10-2 0v1H7V3a1 1 0 00-1-1zm0 5a1 1 0 000 2h8a1 1 0 100-2H6z" clipRule="evenodd" />
                                </svg>
                            </div>
                            <div className="w-[calc(50%-40px)] glass p-6 rounded-xl shadow-xl md:w-5/12">
                                ...
                                <p className="text-stone-500 dark:text-stone-400 font-semibold mb-2">Project InnerSpace | Sep 2023 - Dec 2023</p>
                        ...
                        <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                            ...
                            <div className="w-[calc(50%-40px)] glass p-6 rounded-xl shadow-xl md:w-5/12">
                                ...
                                <p className="text-stone-600 dark:text-stone-400 font-semibold mb-2">LDS Church | Oct 2020 - Nov 2022</p>
