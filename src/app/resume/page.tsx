            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <button
                        ...
                        className="px-8 py-4 bg-gradient-to-r from-amber-700 to-stone-600 text-white font-semibold rounded-full hover:shadow-xl transition-all duration-300 hover:scale-105"
                    >
                        Download PDF
                    </button>
                </div>
                ...
                <div className="space-y-12">
                    ...
                    <section className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <div className="flex flex-wrap justify-center gap-4 text-gray-600 dark:text-gray-400">
                            <a href="mailto:uboston@byu.edu" className="hover:text-amber-700 dark:hover:text-amber-400 transition-colors">
                                uboston@byu.edu
                            </a>
                            <span>•</span>
                    ...
                    <section className={`transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-white flex items-center">
                            <svg className="w-8 h-8 mr-3 text-amber-700" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div className="glass p-6 rounded-xl space-y-4">
                            <div>
                                ...
                                <p className="text-amber-700 dark:text-amber-400 font-semibold mb-2">Brigham Young University - Marriott School of Business | Expected Apr 2027</p>
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
                                ...
                                <ul className="mt-4 space-y-2 text-gray-700 dark:text-gray-300">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 mr-2 text-amber-700 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <section className={`transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="glass p-6 rounded-xl">
                                ...
                                <p className="text-amber-800 dark:text-amber-300 font-semibold mb-4">Peterson Partners | May 2026 – Present</p>
                                <p className="text-gray-600 dark:text-gray-400 mb-3 italic">Salt Lake City, UT</p>
                                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 mr-2 text-amber-800 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="glass p-6 rounded-xl">
                                ...
                                <p className="text-amber-700 dark:text-amber-400 font-semibold mb-4">BYU Office of Information Technology | Jan 2024 - Apr 2026</p>
                            ...
                            <div className="glass p-6 rounded-xl">
                                ...
                                <p className="text-stone-600 dark:text-stone-400 font-semibold mb-4">Connor Group | Jun 2025 - Aug 2025</p>
                                <p className="text-gray-600 dark:text-gray-400 mb-3 italic">Lehi, UT</p>
                                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 mr-2 text-stone-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                                        </svg>
                            ...
                            <div className="glass p-6 rounded-xl">
                                ...
                                <p className="text-amber-600 dark:text-amber-400 font-semibold mb-4">BK Underwood Marketing LLC | Jan 2024 - Present</p>
                                <p className="text-gray-600 dark:text-gray-400 mb-3 italic">Provo, UT</p>
                                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 mr-2 text-amber-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                                        </svg>
                            ...
                            <div className="glass p-6 rounded-xl">
                                ...
                                <p className="text-stone-500 dark:text-stone-400 font-semibold mb-4">The Church of Jesus Christ of Latter-day Saints | Oct 2020 - Nov 2022</p>
                                <p className="text-gray-600 dark:text-gray-400 mb-3 italic">Las Vegas, NV</p>
                                <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                                    <li className="flex items-start">
                                        <svg className="w-5 h-5 mr-2 text-stone-500 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
                                        </svg>
                    ...
                    <section className={`transition-all duration-1000 delay-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                        ...
                        <div className="glass p-6 rounded-xl space-y-4">
                            <div>
                                ...
                                <p className="text-amber-700 dark:text-amber-400 font-semibold mb-2">National Advanced Youth Leadership Experience | Jun 2016 - Jul 2020</p>
